      ...
      <div className="container">
        ...
        <div className="row row-cols-1 row-cols-md-4">
          <div className="col mb-3 mb-md-0">
            <div className="card p-2" style={{ height: '100%' }}>
              <div className="card-body">
                <img src="assets/icon/icon_complete.svg" className="card-img-top" alt="complete" style={{ width: '32px', height: '32px' }} />
          ...
          <div className="col mb-3 mb-md-0">
            <div className="card p-2" style={{ height: '100%' }}>
              <div className="card-body">
                <img src="assets/icon/icon_price.svg" className="card-img-top" alt="price" style={{ width: '32px', height: '32px' }} />
          ...
          <div className="col mb-3 mb-md-0">
            <div className="card p-2" style={{ height: '100%' }}>
              <div className="card-body">
                <img src="assets/icon/icon_24hrs.svg" className="card-img-top" alt="24jam" style={{ width: '32px', height: '32px' }} />
          ...
          <div className="col mb-3 mb-md-0">
            <div className="card p-2" style={{ height: '100%' }}>
              <div className="card-body">
                <img src="assets/icon/icon_professional.svg" className="card-img-top" alt="sopir" style={{ width: '32px', height: '32px' }} />
